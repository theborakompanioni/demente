...
@ConfigurationProperties(
        prefix = "org.tbk.nostr.demented.relay",
        ignoreUnknownFields = false
)
@Getter
@AllArgsConstructor(onConstructor = @__(@ConstructorBinding))
public class DementedRelayProperties implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return clazz == DementedRelayProperties.class;
    }

    @Override
    public void validate(Object target, Errors errors) {
        DementedRelayProperties properties = (DementedRelayProperties) target;
